...
export default function OrdersList() {
  ...
  const cancelDelete = () => {
    ...
    function onMenuClick(_id: string): void {
      ...
      {showConfirm && selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <p className="mt-4 text-sm text-gray-600">Es-tu sûr(e) de vouloir supprimer la commande <span className="font-mono">{selected.id}</span>? Cette action est irréversible (côté UI).</p>
